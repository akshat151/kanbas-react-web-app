                ...
                <div className="container-fluid mb-4">
                    <div className="row">
                        <div className="col-sm-12">
                            ...
                            <p className="wd-custom-font-footer">100 points • Sep 25 at 11.59pm</p>
                        </div>
                    </div>
                </div>
                ...
                <div className="container-fluid">
                    <div className="row p-3">
                        ...
                        <div className="col-10">
                            ...
                            <p className="wd-custom-font-footer p-0 m-0">Sept 20 at 10:15am</p>
                        </div>
                    </div>
                    <div className="row p-3">
                        <div className="col-1">
                        ...
                        <div className="col-10">
                            ...
                            <p style={{ color: "black" }} className="wd-custom-font p-0 m-0">CS5610.12631.202410</p>
                            <p className="wd-custom-font-footer p-0 m-0">Sept 25 at 8pm</p>
                        </div>
                    </div>
                </div>
            </div>
