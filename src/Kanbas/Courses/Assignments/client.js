...
const COURSES_URL = "https://kanbas-node-server-app-1zfu.onrender.com/api/courses";
const ASSIGNMENTS_URL = "https://kanbas-node-server-app-1zfu.onrender.com/api/assignments";
